---
name: specdd-test
description: Use when Antigravity needs to derive, add, update, or assess focused tests from active SpecDD `Must`, `Scenario`, `Handles`, `Returns`, `Raises`, `Tasks`, or `Done when` contracts.
license: Apache-2.0
---
