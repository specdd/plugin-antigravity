---
name: specdd-docs
description: Use when Antigravity needs to write or update user, developer, release, onboarding, or operational documentation from SpecDD specs while preserving source contract boundaries and avoiding unsupported promises.
license: Apache-2.0
---
